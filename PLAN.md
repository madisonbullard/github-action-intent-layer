...
- [x] 1.4 Configure Biome for linting and formatting (root config)
...
- [x] 10.7 Write unit tests for checkbox handler
...
- [x] 12.2 Handle symlink conflict → fail action with clear error message
...
- [x] 12.7 Ensure action fails cleanly with informative error messages
